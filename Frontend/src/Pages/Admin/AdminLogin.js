    ...
    return (
        <div className="student-auth-page">
            ...
            <div className="signup-container">
                ...
                <TextField id="standard-basic" style={{margin:"10px"}} label="Admin Name" variant="standard" type="text" name="school_about" onChange={(e)=>setschool_about(e.target.value)}  required />
